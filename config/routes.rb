Erpv1::Application.routes.draw do
  ...
  namespace :api do
    ...
    match '/connection/signin' => "connection#signin", :via => :post
    match '/connection/signup' => "connection#signup", :via => :post
    match '/connection/signout' => "connection#signout", :via => [:get, :post]
    #match "/contact_infos" => "contact_infos#create", :via => "options"
  end
